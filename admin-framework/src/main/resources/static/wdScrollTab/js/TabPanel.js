...
TabPanel.prototype = {
  ...
  kill: function(a, c) {
    ...
    for (var d = 0; d < this.tabs.length; d++) {
      ...
      this.tabs[d].refresher.bind("click",
      function(f) {
        return function() {
          e.refresh(f)
        }
