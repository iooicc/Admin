...
import my.common.wechat.utils.PaymentUtils;
...
public class PaymentApi {
    ...
    public static String pushOrder(Map<String, String> params) {
    	String body = PaymentUtils.toXml(params);
    	return HttpRequest.post(unifiedOrderUrl)
    	.body(body)
    	.execute().body();
    }
    ...
    private static Map<String, String> request(String url, Map<String, String> params, String paternerKey) {
        ...
        String sign = PaymentUtils.createSign(params, paternerKey);
        params.put("sign", sign);
        String xmlStr = HttpRequest.post(url)
            	.body(PaymentUtils.toXml(params))
            	.execute().body();
        return PaymentUtils.xmlToMap(xmlStr);
    }
    ...
    public static String getDeepLink(String appId, String prepayId, String paternerKey) {
        ...
        String string1 = PaymentUtils.packageSign(params, true);

        String string2 = "";
        try { string2 = PaymentUtils.urlEncode(string1); } catch (UnsupportedEncodingException e) {}
    ...
    public static Map<String, String> refund(Map<String, String> params, String paternerKey, String certPath) {
        ...
        String xmlStr = HttpRequest.post(refundUrl)
        		.body(PaymentUtils.toXml(params))
        		.execute().body();
//        		HttpUtils.postSSL(refundUrl, PaymentUtils.toXml(params), certPath, partner);
        return PaymentUtils.xmlToMap(xmlStr);
    }
    ...
    public static String downloadBill(String appid, String mch_id, String paternerKey, String billDate, BillType billType) {
        ...
        String sign = PaymentUtils.createSign(params, paternerKey);
        params.put("sign", sign);
        return HttpRequest.post(downloadBillUrl)
        	.body(PaymentUtils.toXml(params))
        	.execute().body();
    }
